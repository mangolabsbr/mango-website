...
const SideNav = ({ className }: Props) => {
  ...
  return (
    <div className={className}>
      ...
      <div
        className={`flex fixed w-screen h-screen top-0 right-0 z-10 overflow-hidden ${isOpen ? "" : "pointer-events-none"}`}
      >
        <button
          type="button"
          onClick={close}
        ...
        />
        <nav
          className={`side-panel block w-[300px] border-l-2 border-black bg-white ${isOpen ? "mr-0" : "-mr-[300px]"}`}
        >

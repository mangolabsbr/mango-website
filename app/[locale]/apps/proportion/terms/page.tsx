...
export async function generateMetadata({
  ...
  return legalMetadata(locale as Locale, "proportion", "terms");
}

export default async function ProportionTermsPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const t = await getTranslations("apps.proportion.terms");

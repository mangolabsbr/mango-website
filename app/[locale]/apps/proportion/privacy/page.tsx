...
export async function generateMetadata({
  ...
  return legalMetadata(locale as Locale, "proportion", "privacy");
}

export default async function ProportionPrivacyPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const t = await getTranslations("apps.proportion.privacy");
